        ...
        <div className="mb-5 pb-5">
            ...
            <form className="container mt-5 pt-5">
                <div className="mb-3">
                    ...
                    <input type="email" className="form-control w-50 mx-auto input-field" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your Email" />
                    <div id="emailHelp" className="form-text">We'll never share your email with anyone else.</div>
                </div>
                <div className="mb-3">
                    <label htmlFor="exampleInputPassword1" className="form-label">Password</label>
                    <input type="password" className="form-control l w-50 mx-auto input-field" id="exampleInputPassword1" placeholder="Password" />
                </div>
